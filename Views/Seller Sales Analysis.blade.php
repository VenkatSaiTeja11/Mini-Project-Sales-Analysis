...
<body>
	...
	<br/>
	<div class="text-center"><h3>Do you want to view the <a href="/seller_transaction_history">transaction history</a> ?</h3></div>
	</br>
	<!-- Insights section -->
	<section>
		...
		<div class="text-dark rounded text-center font-weight-bold insights-left mt-2">
			...
			On an average, your customers buy {{$PurchaseFrequency}} products on every visit.
		</div>
		
		<div class="text-dark rounded text-center font-weight-bold insights-right mt-2">
			<h3>Total Number Of Customers</h3>
			Since the last 30 days, {{$TotalCustomers}} customers have visitied your store.
		</div>
